...
eval("// Imports\nvar ___CSS_LOADER_API_IMPORT___ = __webpack_require__(/*! ../../node_modules/css-loader/dist/runtime/api.js */ \"./node_modules/css-loader/dist/runtime/api.js\");\nexports = ___CSS_LOADER_API_IMPORT___(false);\nexports.push([module.i, \"@import url(https://fonts.googleapis.com/css?family=Poppins:200,300,400,500,600,700,800,900&display=swap);\"]);\n// Module\nexports.push([module.i, \".start{transition:opacity 1.5s;display:flex;justify-content:center;align-items:center;background:#000}.start.hide{opacity:0}a.menu{position:relative;padding:10px 30px;margin:0 15px;color:#21ebff;text-decoration:none;text-transform:uppercase;letter-spacing:2px;font-size:20px;transition:.5s;-webkit-box-reflect:below 2px linear-gradient(transparent, #0003)}a.menu:nth-child(1){filter:hue-rotate(115deg)}a.menu:nth-child(3){filter:hue-rotate(270deg)}a.menu:hover{background:#21ebff;color:#111;box-shadow:0 0 50px #21ebff;transition-delay:.5s}a.menu:before{content:\\\"\\\";position:absolute;top:0;left:0;width:10px;height:10px;border-top:2px solid #21ebff;border-left:2px solid #21ebff;transition:.5s;transition-delay:.5s}a.menu:hover:before{width:98%;height:96%;transition-delay:0s}a.menu:after{content:\\\"\\\";position:absolute;bottom:0;right:0;width:10px;height:10px;border-bottom:2px solid #21ebff;border-right:2px solid #21ebff;transition:.5s;transition-delay:.5s}a.menu:hover:after{width:98%;height:96%;transition-delay:0s}html{box-sizing:border-box;font-size:16px}*,*:before,*:after{box-sizing:border-box;margin:0;padding:0;font-family:\\\"Poppins\\\",sans-serif}body{display:flex;justify-content:center;align-items:center;flex-direction:column;background-color:#000;width:100vw;height:100vh}.d-none{display:none}.weather{margin-top:70px;opacity:0;transition:opacity 500;height:70%;width:60%;color:#21ebff}.weather .weather-data{height:200px;width:100%;background-color:gray}.weather.show{opacity:1}.weather:before{content:\\\"\\\";position:absolute;top:15%;left:20%;width:10px;height:10px;border-top:2px solid #21ebff;border-left:2px solid #21ebff;transition:.5s;transition-delay:.5s}.weather.show:before{width:58%;height:68%;transition-delay:0s}.weather:after{content:\\\"\\\";position:absolute;bottom:15%;right:20%;width:10px;height:10px;border-bottom:2px solid #21ebff;border-right:2px solid #21ebff;transition:.5s;transition-delay:.5s}.weather.show:after{width:58%;height:68%;transition-delay:0s}.back{opacity:0;transition:opacity 1500;display:flex;justify-content:center;align-items:center;margin-top:50px;height:20px;width:50px}.back.show{opacity:1}.back a.menu{filter:hue-rotate(0deg)}\", \"\"]);\n// Exports\nmodule.exports = exports;\n\n\n//# sourceURL=webpack:///./src/styles/styles.scss?./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js??ref--4-2");
