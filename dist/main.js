...
eval("// Imports\nvar ___CSS_LOADER_API_IMPORT___ = __webpack_require__(/*! ../../node_modules/css-loader/dist/runtime/api.js */ \"./node_modules/css-loader/dist/runtime/api.js\");\nexports = ___CSS_LOADER_API_IMPORT___(false);\nexports.push([module.i, \"@import url(https://fonts.googleapis.com/css?family=Poppins:200,300,400,500,600,700,800,900&display=swap);\"]);\n// Module\nexports.push([module.i, \".start{transition:opacity 1s;display:flex;justify-content:center;align-items:center;background:#000}.start.hide{opacity:0}a.menu{position:relative;padding:10px 30px;margin:0 15px;color:#21ebff;text-decoration:none;text-transform:uppercase;letter-spacing:2px;font-size:20px;transition:.5s;-webkit-box-reflect:below 2px linear-gradient(transparent, #0003)}a.menu:nth-child(1){filter:hue-rotate(115deg)}a.menu:nth-child(3){filter:hue-rotate(270deg)}a.menu:hover{background:#21ebff;color:#111;box-shadow:0 0 50px #21ebff;transition-delay:.5s}a.menu:before{content:\\\"\\\";position:absolute;top:0;left:0;width:10px;height:10px;border-top:2px solid #21ebff;border-left:2px solid #21ebff;transition:.5s;transition-delay:.5s}a.menu:hover:before{width:98%;height:96%;transition-delay:0s}a.menu:after{content:\\\"\\\";position:absolute;bottom:0;right:0;width:10px;height:10px;border-bottom:2px solid #21ebff;border-right:2px solid #21ebff;transition:.5s;transition-delay:.5s}a.menu:hover:after{width:98%;height:96%;transition-delay:0s}.w-nav{position:relative}.w-nav .search{position:absolute;margin:auto;top:0;right:260px;left:0;bottom:0;width:48px;height:48px;background-color:#21ebff;border-radius:50%;z-index:4;box-shadow:0 0 25px 0 rgba(0,0,0,.4);transition:1s all}.w-nav .search:hover{cursor:pointer}.w-nav .search::before{content:\\\" \\\";position:absolute;margin:auto;top:22px;left:22px;right:0;bottom:0;width:12px;height:2px;background-color:#fff;transform:rotate(45deg);transition:.5s all}.w-nav .search::after{content:\\\" \\\";position:absolute;margin:auto;top:-5px;left:-5px;right:0;bottom:0;width:25px;height:25px;border-radius:50%;border:2px solid #fff;transition:.5s all}.w-nav input{position:absolute;margin:auto;top:0px;left:0px;right:0;bottom:0;width:300px;height:45px;outline:none;border:none;background-color:#21ebff;color:#fff;text-shadow:0 0 10px #21ebff;padding:0 80px 0 20px;border-radius:30px;box-shadow:0 0 25px 0 #21ebff,0 20px 25px 0 rgba(0,0,0,.2);opacity:0;z-index:5;letter-spacing:.1em;transition:1s all}.w-nav input:hover{cursor:pointer}.w-nav input:focus{width:300px;opacity:1;cursor:text}.w-nav input:focus~.search{right:-260px;background-color:#151515;z-index:6}.w-nav input:focus~.search::before{top:0;left:0;width:25px}.w-nav input:focus~.search::after{top:0;left:0;width:25px;height:2px;border:none;background-color:#fff;border-radius:0;transform:rotate(-45deg)}.w-nav input::placeholder{color:#fff}html{box-sizing:border-box;font-size:16px}*,*:before,*:after{box-sizing:border-box;margin:0;padding:0;font-family:\\\"Poppins\\\",sans-serif}body{display:flex;justify-content:center;align-items:center;flex-direction:column;background-color:#000;width:100vw;height:100vh}.d-none{display:none}.weather{opacity:0;transition:opacity 1s;height:81%;width:60%;color:#21ebff}.weather.show{opacity:1}.weather:before{content:\\\"\\\";position:absolute;top:5%;left:20%;width:10px;height:10px;border-top:4px solid #21ebff;border-left:4px solid #21ebff;border-radius:4px;transition:.5s;transition-delay:.5s}.weather.show:before{width:59%;height:79%;transition-delay:0s}.weather:after{content:\\\"\\\";position:absolute;bottom:14%;right:20%;width:10px;height:10px;border-bottom:4px solid #21ebff;border-right:4px solid #21ebff;border-radius:4px;transition:.5s;transition-delay:.5s}.weather.show:after{width:59%;height:79%;transition-delay:0s}.back{opacity:0;transition:opacity 1s;display:flex;justify-content:center;align-items:center;margin-top:50px;height:20px;width:50px}.back.show{opacity:1}.back a.menu{filter:hue-rotate(0deg)}.w-container{margin:auto;display:flex;flex-direction:column;justify-content:space-between;align-items:center;width:98%;height:98%}.w-container .w-nav{width:98%;height:10%}.w-container .w-body{width:98%;height:88%;background-color:#17151c}.w-body .not-found-base{width:100%;height:100%;display:none;justify-content:center;align-items:center}.w-body .not-found-base .not-found-box{position:relative;transition:.5s;-webkit-box-reflect:below 5px linear-gradient(transparent, #0003)}.w-body .not-found-base .not-found-box h3{text-transform:uppercase;letter-spacing:2px;font-size:20px;font-weight:500;padding:10px;margin:10px 20px}.w-body .not-found-base .not-found-box.show{background:#21ebff;color:#111;box-shadow:0 0 10px #21ebff;transition-delay:.5s}.w-body .not-found-base .not-found-box:before{content:\\\"\\\";position:absolute;top:0;left:0;width:10px;height:10px;border-top:2px solid #21ebff;border-left:2px solid #21ebff;transition:.5s;transition-delay:.5s}.w-body .not-found-base .not-found-box.show:before{width:98%;height:96%;transition-delay:0s}.w-body .not-found-base .not-found-box:after{content:\\\"\\\";position:absolute;bottom:0;right:0;width:10px;height:10px;border-bottom:2px solid #21ebff;border-right:2px solid #21ebff;transition:.5s;transition-delay:.5s}.w-body .not-found-base .not-found-box.show:after{width:98%;height:96%;transition-delay:0s}\", \"\"]);\n// Exports\nmodule.exports = exports;\n\n\n//# sourceURL=webpack:///./src/styles/styles.scss?./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js??ref--4-2");
